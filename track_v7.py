...
def detect(opt):
    ...
    for path, img, im0, vid_cap in dataset:
        ...
        if detections.any():
            ...
            sort_output = strong_sort.update(xyxys, confs, classes, im0[:, :, [2, 1, 0]])
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--feature-bank-size',
        type=int, default=1,
        help='Keep the feature vectors of the last N associated detections for appearance comparisons.'
    )
